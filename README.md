...
Обязательно используй Webpack или Parcel для сборки и деплоя проекта. Настраивать собственную сборку не нужно, вот ссылки на готовые, читай README и используй - Parcel или Webpack.
